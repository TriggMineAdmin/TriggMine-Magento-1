/*global require*/
require(["fpModule/fingerprint2", "jsCookie/jscookie", "json3/json3.min", "restful/restful.min", "clientJs/client.min"], function (fingerprint, Cookies, JSON3, RestFul) {
    ...
    new fingerprint(options).get(function (result) {
       ...
       // Cookies.set("data", data, {path: '/', expires: 7});
        ...
        const api = RestFul('http://m1-api.triggmine.com.ua/acc/api/events/cart/onFullCartChange', false);
